...
public class IPv4Util {
    ...
    /**
     * 使用正则表达式将字符串形式的 IPv4 地址转换为字节数组形式
     * @param ipAddr
     * @return
     */
    ...
    /**
     * 根据 IP 地址和子网掩码获取 IP 地址段的字符串形式范围
     * @param ipAndMask
     * @return
     */
